...
public class Main {
    public static void main(String[] args) {
        ...
        PassengerCars PassengerCars3 = new PassengerCars("BMW", "Z8",
                4.0f, 22, 190, 11, BodyTypePC.COUPE, Type.CAR, Transport.mechanic, Driver.driverB3);
        PassengerCars PassengerCars4 = new PassengerCars("Kia", "Sportage_4_generation",
                3.0f, 25, 210, 8, BodyTypePC.SUV, Type.CAR, Transport.mechanic, Driver.driverB4);
        ...
        Bus bus1 = new Bus("Liaz", "S54",
                5.2, 22, 95, 3, CapacityBus.Big, Type.BUS, Transport.mechanic, Driver.driverD1);
        Bus bus2 = new Bus("LAZ", "N8",
                7.0, 20, 89, 4, CapacityBus.Average, Type.BUS, Transport.mechanic, Driver.driverD2);
        Bus bus3 = new Bus("PAZ", "96",
                7.5, 18, 96, 5, CapacityBus.EspeciallySmall, Type.BUS, Transport.mechanic, Driver.driverD3);
        Bus bus4 = new Bus("Nefaz", "196",
                10.5, 15, 105, 3, CapacityBus.EspeciallyBig, Type.BUS, Transport.mechanic, Driver.driverD4);
        ...
        Trucks trucks1 = new Trucks("Gaz", "66",
                7.0f,18, 110, 4, TypeLoadCapacityTrucks.N1, Type.TRUCK, Transport.mechanic, Driver.driverC1);
        Trucks trucks2 = new Trucks("Kamaz", "T45",
                12.0f, 20, 100, 5, TypeLoadCapacityTrucks.N2, Type.TRUCK, Transport.mechanic, Driver.driverC2);
        Trucks trucks3 = new Trucks("Volvo", "Z60",
                8.5f, 15, 115, 6, TypeLoadCapacityTrucks.N2, Type.TRUCK, Transport.mechanic, Driver.driverC3);
        Trucks trucks4 = new Trucks("Ural", "66",
                13.5f, 16, 108, 5, TypeLoadCapacityTrucks.N3, Type.TRUCK, Transport.mechanic, Driver.driverC4);
